    ...
    <Container maxWidth="md" sx={{ py: 8 }}>
      ...
      >
        ...
        >
          ...
          <desc id="d">Ilustração simples com o número 404 e uma claquete.</desc>
          ...
          <g fill="none" stroke="currentColor" strokeWidth="8" strokeLinecap="round" strokeLinejoin="round">
            <g transform="translate(60,70)">
              ...
              <path d="M12 0 L30 32 M44 0 L62 32 M76 0 L94 32 M108 0 L126 32" strokeWidth="6"></path>
            </g>
          ...
          <g fill="currentColor" fontFamily="Inter, system-ui, Segoe UI, Roboto, Arial" textAnchor="middle">
            <text x="300" y="208" fontSize="16" opacity=".8">Página não encontrada</text>
          </g>
        </Box>
      </Box>
    </Container>
